                ...
                <div class="card-body">
                    ...
                    <section class="mysection">
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddIntinfo()}}" class="graph intellect" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsInt()}}%; background: linear-gradient(0deg, rgb(197, 237, 26), rgba(217, 233, 159, 1));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Intellectual</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddCreinfo()}}" class="graph create" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsCre()}}%; background: linear-gradient(0deg, rgb(209, 221, 212), rgb(61, 230, 131));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Creative</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddSocinfo()}}" class="graph social" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsSoc()}}%; background: linear-gradient(0deg, rgb(221, 209, 210), rgb(230, 61, 98));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Social</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddPreinfo()}}" class="graph percept" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsPer() }}%; background: linear-gradient(0deg, rgb(168, 200, 226), rgb(61, 92, 230));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Perceptual</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddMucinfo()}}" class="graph musc" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsMuc() }}%; background: linear-gradient(0deg, rgb(226, 186, 168), rgb(230, 123, 61));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Muscular</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddMocinfo()}}" class="graph motor" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsMoc() }}%; background: linear-gradient(0deg, rgb(168, 226, 216), rgb(61, 224, 230));">
                                <div class="result"> </div>
                            </div>
                            <div class="category">Motor</div>
                        </div>
                        <div class="section-box">
                            <div data-toggle="tooltip" data-placement="top" title="{{App\Http\Controllers\ViewAddInfoContent::teacherAddSptinfo()}}" class="graph spir" style="height: {{App\Http\Controllers\ViewTeacherResults::teacherResultsSp() }}%; background: linear-gradient(0deg, rgb(212, 168, 226), rgb(154, 61, 230));">
                                <div class="result"> </div>
                            </div>
                    ...
                    <div class="about-tree pt-3">
                        <div class="title-about-tree ml-sm-3 pt-3">
