...
<div class="container">
    <div>
        ...
        <div class="row justify-content-center" style="padding: 10px">
            ...
            <p>Gives key indicators of whether your child displays characteristics of
            <span class="otherspan">giftedness</span> such as
                ...
                <span class="myspan">imagination</span>.</p></div>

            <div class="card col home-cards" style="font-size: 175%;">
            Set Up Your Profile Today<br><a class="mya" href="{{ route('register') }}"><span class="boldspan">Click Here</span></a></div>
            ...
            <p>This checklist will provide an overarching picture of children’s
                ...
                <span class="otherspan">strengths</span>.</p> </div>
    </div>
</div>
@endsection
